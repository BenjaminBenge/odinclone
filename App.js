...
function App() {
  return (
    <body className="h-full bg-gray-50 text-gray-600 dark:bg-gray-900 dark:text-gray-300">
      <div className="">
        ...
        <div class="hero-image">
          <div class="hero-text">
            <h1>
              ...
              <span class="gold">Career in Web Development </span>{" "}
              <span className="fall"> Starts Here</span>
            </h1>
          </div>
        </div>
        <div className="p1">
          <p className="Pa text-xl">
            Our full stack curriculum is free and supported by
            <span className="middles"> passionate </span>
            <span className="roro">open source community</span>
          </p>
        </div>
        <button className="Button1">View Full Curriculum</button>
        {/*  <img src={homeisometric} className="navigation-logo" alt="logo" /> */}
      ...
      <div className="section2">
        <div className="how">
          ...
          <div className="box-frames">
            <div className="ing">
              <div className="Learn">
                <img
                  className="image"
                  alt
                  src="https://www.theodinproject.com/assets/img-learn-aded43a474618b12bf884b2577ef4548962b3d8e8ef5381de0bc6f4f86f8b2b3.svg"
                ></img>
                <h3 className="hehe">Learn</h3>
            ...
            <div className="ing">
              <div className="Learn">
                <img
                  className="image"
                  alt
                  src="https://www.theodinproject.com/assets/img-build-097e94bec94feb4b9152f9f95c197be4974f9921ce6fe8fc6ed86541933b3c14.svg"
                ></img>
                <h3 className="hehe">Build</h3>
                <div className="paragraphs">
                  <p>
                    Build dozens of portfolio-worthy projects along the way,
                    from simple scripts to full programs and deployed websites.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="ing">
              <div className="Learn">
                <img
                  className="image"
                  alt
                  src="https://www.theodinproject.com/assets/img-connect-fa7fdbed3b8a50275b5a79a293133b0a4b7b0c618230c6c7cad978c9e13122db.svg"
                ></img>
                <h3 className="hehe">Connect</h3>
                <div className="paragraphs">
                  <p>
      ...
      <div className="yoyo">
        <div className="middle">
          <h2 className="">Learn everything you need to know</h2>
        </div>
        ...
        <div className="uphold">
          <div className="behold">
            <div className="wacha">
              <div className="wewe">
                <div className="namgini">
                  <a
                    className="boxes"
                    href="/paths/full-stack-ruby-on-rails/courses/ruby"
                  >
                    <img
                      alt
                      className="ges"
                      src="https://www.theodinproject.com/assets/badge-ruby-d91c1849066ed424531394e9d693dd99aaef49bcee15a96f462a1ae54c359af0.svg"
                    ></img>
                    <h3 className="course">Ruby</h3>
                  </a>

                  <a
                    className="boxes"
                    href="https://www.theodinproject.com/paths/full-stack-ruby-on-rails/courses/databases"
                  >
                    <img
                      alt
                      className="ges"
                      src="https://www.theodinproject.com/assets/badge-database-feffd1ceb24267152793e33ea95e98ffeb3d203fd62d77302ac165dcfc421349.svg"
                    ></img>
                    <h3 className="course">Database</h3>
                  </a>

                  <a
                    className="boxes"
                    href="https://www.theodinproject.com/paths/full-stack-ruby-on-rails/courses/ruby-on-rails"
                  >
                    <img
                      alt
                      className="ges"
                      src="https://www.theodinproject.com/assets/badge-ruby-on-rails-0100b2e2593cbeb4d87e92e9fc9930448581ef43b8ab175d5cfef2b6e7e3f29c.svg"
                    ></img>
                    <h3 className="course">Ruby on Rails</h3>
                  </a>
                  ...
                  >
                    <img
                      alt
                      className="ges"
                      src="https://www.theodinproject.com/assets/badge-html-css-91bc8d9c7ebb2e2f73eeb302c38a92d9ba6f182301dbd1868d7198fcc8376aeb.svg"
                    ></img>
                    <h3 className="course">Intermediate HTML and CSS</h3>
                  </a>
                  ...
                  >
                    ...
                    <h3 className="course">Advanced HTML and CSS</h3>
                  </a>
                  ...
                  >
                    <img
                      ...
                      src="https://www.theodinproject.com/assets/badge-ruby-d91c1849066ed424531394e9d693dd99aaef49bcee15a96f462a1ae54c359af0.svg"
                    ></img>
                    <h3 className="course">Node JS</h3>
                  </a>
                  ...
                  >
                    <img
                      ...
                      src="https://www.theodinproject.com/assets/badge-ruby-d91c1849066ed424531394e9d693dd99aaef49bcee15a96f462a1ae54c359af0.svg"
                    ></img>
                    <h3 className="course">Getting Hired</h3>
                  </a>
                  ...
                  >
                    <img
                      ...
                      src="https://www.theodinproject.com/assets/badge-ruby-d91c1849066ed424531394e9d693dd99aaef49bcee15a96f462a1ae54c359af0.svg"
                    ></img>
                    <h3 className="course">Javascript</h3>
                  </a>
                  ...
                  >
                    <img
                      ...
                      src="https://www.theodinproject.com/assets/badge-ruby-d91c1849066ed424531394e9d693dd99aaef49bcee15a96f462a1ae54c359af0.svg"
                    ></img>
                    <h3 className="course">React</h3>
                  </a>
                </div>
              </div>
            </div>
            <div className="hola">
              <a className="butt" href="https://www.theodinproject.com/paths">
                Explore curriculum
              </a>
            </div>
          </div>
      ...
      <div className="megu">
        <div className="page-container">
          <div className="texts">
            <h2 className="ogwen"> Success Stories</h2>
          </div>

          <div className="kele-wagwan">
            <div className="hold">
              <div className="hold-pic">
                <img
                  alt
                  class="picture"
                  src="https://www.theodinproject.com/assets/success_stories/andrej_dragojevic-bcd48746a443efaac8fbebccac7ed0d1d946b331bbd01855cab5772d6ada86f5.jpg"
                ></img>
              </div>
              <div className="xoxo">
                <p>
                  ...
                  <div className="write">
                    <p>
                      An incredible self-paced curriculum that consists of the
                      best resources for learning programming on the web! It was
                      an invaluable resource on my path to a becoming a software
                      developer.
                    </p>
                  </div>
                </p>
          ...
          <div className="justify">
            <a
              className="yigs"
              href="https://www.theodinproject.com/success_stories"
            >
          ...
          <div className="bvb">
            <div className="iinn">
              <div className="support">
                <div className="us">
                  <h1 className="swing"> Support Us</h1>
                  <h2 className="stan">
                    {" "}
                    The Odin Project is funded by the community. Join us in
                    empowering learners around the globe by supporting The Odin
                    Project!
                  </h2>
                </div>
                <div className="rey">
                  <a
                    className="what"
                    href="https://www.theodinproject.com/support_us"
                  >
                    Learn More
                  </a>
                  <a
                    className="gwe"
                    target="_blank"
                    href="https://opencollective.com/theodinproject/donate?amount=5"
                  >
                    <span className="revolt">Donate Now</span>
                    <svg
                    ...
                    >
                      <path
                        ...
                        d="M17.5 8.25L21 12m0 0l-3.75 3.75M21 12H3"
                      ></path>
                    </svg>
                  </a>
                </div>
      ...
      <footer className="yesir" aria-labelledby="footer-heading">
        <h2 id="footer-header" className="sr-only">
          {" "}
          Footer
        </h2>
          ...
          <div className="rampage">
            <div className="speed">
              ...
              >
                <svg
                  ...
                  fill="none"
                  role="img"
                  arialabelledy="agsui0fzekotteo1yd33ra859qlzd6n"
                  className="tweet"
                >
                  <path
                    fill-rule="evenodd"
                    clip-rule="evenodd"
                    d="M8.68945 34.7331L13.1482 19.2902H30.9833L35.442 34.7331H8.68945Z"
                    fill="#EED9C3"
                  ></path>
                  <ellipse
                    cx="27.7849"
                  ...
                  <path
                    fill-rule="evenodd"
                    clip-rule="evenodd"
                    d="M35.0004 4.5308L43.8517 0L39.0002 18L35.0002 22L35.0004 4.5308Z"
                    fill="#E3B261"
                  ></path>
                  <path
                    fill-rule="evenodd"
                    clip-rule="evenodd"
                    d="M8.8514 4.5308L0.000132561 0L4.85156 18L8.85156 22L8.8514 4.5308Z"
                    fill="#E3B261"
                  ></path>
                  <path
                    fill-rule="evenodd"
              ...
              <div className="yoga">
                <a class="troll" href="https://github.com/TheOdinProject">
                  ...
                  <svg
                    ...
                    aria-hidden="true"
                    role="img"
                    aria-labelledby="aedte3tnos2j3eox8jjzgo3upaukmph0 amn7eg6hived07p77m0jvbhat9aolqwp"
                    className=" transition"
                  >
                    <title id="aedte3tnos2j3eox8jjzgo3upaukmph0">GitHub</title>
                    <desc id="amn7eg6hived07p77m0jvbhat9aolqwp">
                      GitHub logo
                    </desc>
                    <path
                      fill-rule="evenodd"
                ...
                <a className="troll" href="https://discord.gg/fbFCkYabZB">
                  ...
                  <svg
                    ...
                    aria-hidden="true"
                    role="img"
                    aria-labelledby="a1ryjqtvcs9inyh1zo3fxoxts5a0hghb a9445ox4mzibz3cp3zw3dbfuyoakwwds"
                    className=" transition "
                  >
                    <title id="a1ryjqtvcs9inyh1zo3fxoxts5a0hghb">Discord</title>
                    <desc id="a9445ox4mzibz3cp3zw3dbfuyoakwwds">
                      Discord logo
                    </desc>
                ...
                >
                  ...
                  <svg
                    ...
                    aria-hidden="true"
                    role="img"
                    aria-labelledby="ahw8blygamejr1rhydmqeqptfl0r9ym7 amkqnu83b45d4b9mnepflifbx194skas"
                    className="transition"
                  >
                    <title id="ahw8blygamejr1rhydmqeqptfl0r9ym7">
                      Facebook
                    </title>
                    <desc id="amkqnu83b45d4b9mnepflifbx194skas">
                      Facebook logo
                    </desc>
                    <path
                      fill-rule="evenodd"
                ...
                <a className="troll" href="https://twitter.com/TheOdinProject">
                  ...
                  <svg
                    ...
                    aria-hidden="true"
                    role="img"
                    aria-labelledby="atoisdsu2wh39c1nxc63ln9if4ezzs8x a9x3zrolip7imockol6uem9rktcmtvam"
                    className=" transition"
                  >
                    <title id="atoisdsu2wh39c1nxc63ln9if4ezzs8x">Twitter</title>
                    <desc id="a9x3zrolip7imockol6uem9rktcmtvam">
                      Twitter logo
                    </desc>
            ...
            <div className="trumpet">
              <div className="spaces">
                <div>
                  <h3 className="leading">About Us</h3>
                  <ul role="list" className="mt-4">
                    <li></li>
                    <li>
                      <a
                        className="wiwi"
                        href="https://www.theodinproject.com/team"
                      >
                        Team
                      </a>
                    </li>
                    ...
                    <li>
                      <a
                        className="wiwi"
                        href="https://www.theodinproject.com/success stories"
                      >
                        Success Stories
                      </a>
                    </li>
